...
[Get Postman Collection](http://erp.crowdafricahost.xyz/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://erp.crowdafricahost.xyz/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"impedit","ip_address":"aperiam","latitude":"voluptatum","longitude":"dolore"}'
...
```bash
curl -X POST \
    "http://erp.crowdafricahost.xyz/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"rerum","latitude":"asperiores","longitude":"quia"}'
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/holidays?location_id=deleniti&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=doloremque&follow_up_type=sapiente&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"neque","schedule_type":"ea","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=ut&biz_name=soluta&mobile_num=7&contact_id=et&order_by=placeat&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://erp.crowdafricahost.xyz/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"est","mobile_name":"in","call_type":"call","start_time":"qui","end_time":"ut","duration":"nobis"}]}'
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=dolorem&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":16,"initial_amount":7652,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":107943559.31908319890499114990234375,"total_card_slips":1,"total_cheques":16,"closing_note":"fuga","transaction_ids":"1,2,3"}'
...
let body = {
    ...
    "status": "close",
    "closing_amount": 107943559.31908319890499114990234375,
    "total_card_slips": 1,
    "total_cheques": 16,
    "closing_note": "fuga",
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/contactapi?type=voluptas&name=aut&biz_name=ad&mobile_num=3&contact_id=quam&order_by=maiores&direction=sapiente&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"enim","prefix":"dolores","first_name":"dolorum","middle_name":"sint","last_name":"omnis","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"perspiciatis","address_line_2":"tempora","city":"quis","state":"quam","country":"nemo","zip_code":"perferendis","customer_group_id":"quae","contact_id":"et","dob":"2000-06-13","custom_field1":"dolorum","custom_field2":"eius","custom_field3":"tempora","custom_field4":"temporibus","email":"vitae","shipping_address":"quia","position":"ut","opening_balance":0,"source_id":6,"life_stage_id":11,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_1": "perspiciatis",
    "address_line_2": "tempora",
    "city": "quis",
    "state": "quam",
    "country": "nemo",
    ...
    "contact_id": "et",
    "dob": "2000-06-13",
    "custom_field1": "dolorum",
    "custom_field2": "eius",
    "custom_field3": "tempora",
    "custom_field4": "temporibus",
    "email": "vitae",
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"molestiae","prefix":"deleniti","first_name":"ipsa","middle_name":"ducimus","last_name":"corporis","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"autem","address_line_2":"a","city":"itaque","state":"qui","country":"dolores","zip_code":"voluptatem","customer_group_id":"voluptatem","contact_id":"voluptatibus","dob":"2000-06-13","custom_field1":"et","custom_field2":"suscipit","custom_field3":"neque","custom_field4":"iste","email":"dignissimos","shipping_address":"odit","position":"vero","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":7,"life_stage_id":15,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "voluptatibus",
    "dob": "2000-06-13",
    "custom_field1": "et",
    "custom_field2": "suscipit",
    "custom_field3": "neque",
    "custom_field4": "iste",
    "email": "dignissimos",
...
```bash
curl -X POST \
    "http://erp.crowdafricahost.xyz/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":8,"card_number":"qui","card_holder_name":"fugiat","card_transaction_number":"odit","card_type":"hic","card_month":"amet","card_year":"optio","card_security":"possimus","transaction_no_1":"nihil","transaction_no_2":"odit","transaction_no_3":"tempore","cheque_number":"voluptas","bank_account_number":"reprehenderit","note":"minus"}'
...
let body = {
    ...
    "account_id": 8,
    "card_number": "qui",
    "card_holder_name": "fugiat",
    "card_transaction_number": "odit",
    "card_type": "hic",
    "card_month": "amet",
    "card_year": "optio",
    "card_security": "possimus",
    "transaction_no_1": "nihil",
    "transaction_no_2": "odit",
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/expense?location_id=vel&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=nisi&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":16,"final_total":62839.2968316149999736808240413665771484375,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":7,"expense_for":12,"contact_id":4,"additional_notes":"natus","is_refund":0,"is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"consequatur","recur_repetitions":8,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":2,"card_number":"iste","card_holder_name":"aperiam","card_transaction_number":"voluptatem","card_type":"quas","card_month":"sit","card_year":"quam","card_security":"aspernatur","transaction_no_1":"omnis","transaction_no_2":"atque","transaction_no_3":"quidem","note":"amet","cheque_number":"ut"}]}'
...
let body = {
    "location_id": 16,
    "final_total": 62839.2968316149999736808240413665771484375,
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://erp.crowdafricahost.xyz/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":8317.79999999999927240423858165740966796875,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":9,"expense_for":19,"contact_id":4,"additional_notes":"et","is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"reiciendis","recur_repetitions":19,"payment":[]}'
...
let body = {
    "final_total": 8317.79999999999927240423858165740966796875,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 9,
    "expense_for": 19,
    "contact_id": 4,
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/expense-refund?location_id=qui&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=dolorem&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/product?brand_id=voluptas&category_id=laudantium&sub_category_id=qui&location_id=et&selling_price_group=possimus&name=et&sku=est&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/product/1?selling_price_group=vel" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "vel",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/variation/?brand_id=omnis&category_id=exercitationem&sub_category_id=dolores&not_for_selling=animi&name=cumque&sku=velit&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/sell?location_id=quos&contact_id=maiores&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=molestiae&service_staff_id=dicta&shipping_status=ordered&only_subscriptions=quasi&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "molestiae",
    "service_staff_id": "dicta",
    "shipping_status": "ordered",
    "only_subscriptions": "quasi",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":11,"contact_id":6,"transaction_date":"2020-07-22 15:48:29","invoice_no":"quia","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":1,"discount_amount":10,"discount_type":"fixed","sale_note":"molestiae","staff_note":"incidunt","commission_agent":3,"shipping_details":"Express Delivery","shipping_address":"tempore","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":12,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":18,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quidem","recur_repetitions":15,"rp_redeemed":18,"rp_redeemed_amount":13.5,"types_of_service_id":16,"service_custom_field_1":"modi","service_custom_field_2":"quod","service_custom_field_3":"deleniti","service_custom_field_4":"eveniet","round_off_amount":45111883.925150938332080841064453125,"table_id":16,"service_staff_id":3,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":6,"note":"quisquam"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":11,"card_number":"minus","card_holder_name":"enim","card_transaction_number":"recusandae","card_type":"cupiditate","card_month":"aliquam","card_year":"voluptas","card_security":"nobis","transaction_no_1":"saepe","transaction_no_2":"non","transaction_no_3":"aut","bank_account_number":"rerum","note":"velit","cheque_number":"in"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "quidem",
            "recur_repetitions": 15,
            "rp_redeemed": 18,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 16,
            "service_custom_field_1": "modi",
            "service_custom_field_2": "quod",
            "service_custom_field_3": "deleniti",
            "service_custom_field_4": "eveniet",
            "round_off_amount": 45111883.925150938332080841064453125,
            "table_id": 16,
            "service_staff_id": 3,
            "change_return": 0,
            "products": [
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://erp.crowdafricahost.xyz/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":12,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":10,"discount_amount":10,"discount_type":"fixed","sale_note":"id","staff_note":"optio","sells":[{"is_suspend":false}],"commission_agent":4,"shipping_details":"Express Delivery","shipping_address":"ducimus","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":19,"pay_term_number":4,"pay_term_type":"months","is_recurring":0,"recur_interval":18,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"quo","recur_repetitions":11,"rp_redeemed":7,"rp_redeemed_amount":13.5,"types_of_service_id":7,"service_custom_field_1":"quo","service_custom_field_2":"enim","service_custom_field_3":"ut","service_custom_field_4":"rerum","round_off_amount":4586606,"table_id":20,"service_staff_id":4,"change_return":0,"change_return_id":13,"products":[{"sell_line_id":15,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":9,"discount_amount":0,"discount_type":"percentage","sub_unit_id":14,"note":"ut"}],"payments":[{"payment_id":4,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":19,"card_number":"est","card_holder_name":"neque","card_transaction_number":"qui","card_type":"quae","card_month":"qui","card_year":"impedit","card_security":"ex","transaction_no_1":"voluptate","transaction_no_2":"ipsam","transaction_no_3":"fuga","note":"repellat","cheque_number":"necessitatibus","bank_account_number":"dolorem"}]}'
    ...
    "payments": [
        {
            ...
            "card_year": "impedit",
            "card_security": "ex",
            "transaction_no_1": "voluptate",
            "transaction_no_2": "ipsam",
...
```bash
curl -X DELETE \
    "http://erp.crowdafricahost.xyz/public/connector/api/sell/esse" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://erp.crowdafricahost.xyz/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":13,"transaction_date":"2020-5-7 15:20:22","invoice_no":"iusto","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":12,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://erp.crowdafricahost.xyz/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":6,"shipping_status":"ordered","delivered_to":"rerum"}'
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/table?location_id=qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/taxonomy?type=ea" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/user?service_staff=sapiente" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/user"
);

let params = {
    "service_staff": "sapiente",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://erp.crowdafricahost.xyz/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"natus","new_password":"et"}'
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/profit-loss-report?location_id=aspernatur&start_date=2018-06-25&end_date=2018-06-25&user_id=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://erp.crowdafricahost.xyz/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://erp.crowdafricahost.xyz/public/connector/api/notifications"
);
